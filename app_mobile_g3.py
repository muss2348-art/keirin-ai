...
st.set_page_config(page_title="競輪AI G3 Mobile", page_icon="🚴", layout="centered")

st.title("🚴 競輪AI G3 Mobile")
st.caption("G3専用Mobile / 穴寄り / ライン崩れ重視 / 学習補正 / 見送りAI / 賭け金AI")
...
with st.expander("⚙️ 設定", expanded=True):
    ...
    race_type = st.selectbox("レース種別", ["G3", "通常", "ガールズ"])
